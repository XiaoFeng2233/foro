<script setup>
import {queryUserNotice} from "@/api/notice.js"
...
const doQueryUserNotice = async () => {
  const response = await queryUserNotice(pageNum.value, pageSize)
  ...
  <DefaultLayout>
    ...
    <div class="page-body">
      <div class="border-0 card">
        <div class="card-body text-center" v-if="pageTotal == 0">
          <h1 class="empty-title">暂无通知</h1>
          <svg xmlns="http://www.w3.org/2000/svg" id="currentIllo" data-name="Layer 1" width="400" height="400"
               viewBox="0 0 1120.59226 777.91584"
               class="injected-svg DownloadModal__ImageFile-sc-p17csy-5 iIfSkb grid_media"
               xmlns:xlink="http://www.w3.org/1999/xlink"><title>not found</title>
            ...
            <path
                ...
                transform="translate(-39.70387 -61.04208)" fill="#f2f2f2"></path>
            <polygon
            ...
            <path
                ...
                transform="translate(-39.70387 -61.04208)" fill="#6c63ff"></path>
            <path
        ...
        <div class="card-body border-0" v-else>
          <div class="list-group list-group-flush list-group-hoverable">
            <div class="list-group-item" v-for="item in noticeData" :key="item.id">
              <div class="row align-items-center">
                <div class="col-auto">
                <span>
                  <span class="avatar" :style="{backgroundImage: `url(${item.image})`}"></span>
                </span>
                </div>
                <div class="col text-truncate">
                  <span class="text-reset d-block text-secondary">{{moment(item.createTime).format('YYYY-MM-DD HH:mm:ss')}}</span>
                  <div class="d-block mt-n1" v-html="item.content">
