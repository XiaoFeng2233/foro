...
import {getInfoByUserId, queryUserTopicByUserId} from "@/api/user.js"
...
const getUserTopicData = async () => {
  const response = await queryUserTopicByUserId(pageNum.value, pageSize, route.params.id)
...
<template>
  <div class="border-0 card card-body">
    <h3 class="card-title">{{ userInfo.username }} 发布的主题</h3>
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-12 markdown home-article">
                      <router-link style="text-decoration: none" :to="{name:'Topic',params:{id:item.id}}"
                                   class="text-reset">
                        <h3 class="text-muted">
    ...
    <div class="mt-2">
      <el-pagination v-model:current-page="pageNum" layout="prev, pager, next" v-if="pageTotal>pageSize"
                     :page-size="pageSize" :total="pageTotal" style="margin-top: 20px;justify-content: center"/>
